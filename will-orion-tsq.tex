...
\begin{xalignat}{3}
  \alpha_1 & = 
  \frac{\T{2}{\F{III}} \Tmax{\F{II}} W_{\F{II}}}
  {\T{2}{\F{II}} \Tmax{\F{III}} W_{\F{III}}} & 
  \beta_1 & = 
  \frac{\T{2}{\F{III}} \Tmax{\F{I}} W_{\F{I}}}
  {\T{2}{\F{II}} \Tmax{\F{III}} W_{\F{III}}} & 
  \gamma_1 & = 
  \frac{\Tmax{\F{I}} W_{\F{I}}}
  {\Tmax{\F{III}} W_{\F{III}}} \nonumber \\[\medskipamount]
  \alpha_2 & = 
  \frac{\T{1}{\F{III}} \Tmax{\F{II}} W_{\F{II}}}
  {\T{1}{\F{I}} \Tmax{\F{III}} W_{\F{III}}} & 
  \beta_2 & = 
   \frac{\T{1}{\F{III}} \Tmax{\F{I}} W_{\F{I}}}
  {\T{1}{\F{I}} \Tmax{\F{III}} W_{\F{III}}} & 
  \gamma_2 & = 
  \frac{\Tmax{\F{II}} W_{\F{II}}}
  {\Tmax{\F{III}} W_{\F{III}}} \nonumber
\end{xalignat}
