...
\newcommand\New[2][]{{\marginpar{\tiny\color{purple}\mbox{#1}}\color{purple}#2}}
...
\textit{Note: this is \New[16 Jul 2014]{similar} to what I wrote in the the calibration
...
continuum sources, the \New{calibration} is only sensitive to the integrated
