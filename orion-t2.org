...
#+BEGIN_SRC python :return table :var intable=filter-sets
  from wfc3_utils import ratio_coefficients, line_transmission_adjustments
  import wfc3_utils
  cols = ["T2/T1", "alpha_1", "alpha_2", "beta_1", "beta_2", "gamma_1", "gamma_2"]

  table = [["I", "II", "III"] + cols, None]

  line_transmission_adjustments[(6583, "F658N")] = 0.9
  line_transmission_adjustments[(5755, "FQ575N")] = 1.09
...
|--------+--------+--------+--------+-----------+-----------+---------+---------+-----------+-----------|
| FQ575N | F658N  | F547M  |  0.882 |    0.7712 | 1.426e-07 | 0.02426 | 0.03939 |  2.34e-07 | 2.313e-08 |
| FQ672N | FQ674N | F673N  | 0.7632 |    0.9698 |     1.157 |   0.164 |  0.1142 |   0.06314 |  0.004533 |
| FQ672N | FQ674N | F547M  | 0.7632 |  1.02e-07 | 2.083e-07 | 0.02742 | 0.01909 |   0.06314 |  0.004533 |
| FQ437N | F502N  | FQ436N |  1.164 |    0.9754 |  1.26e-07 |  0.7111 |   1.998 | 1.449e-07 | 3.061e-08 |
| FQ437N | F502N  | F547M  |  1.164 |  3.92e-06 |  0.001539 | 0.03426 | 0.09627 | 1.449e-07 | 3.061e-08 |
| F487N  | F656N  | F547M  | 0.9116 | 2.538e-06 | 1.107e-07 | 0.08711 | 0.02375 |  5.69e-07 | 6.471e-08 |
...
#+BEGIN_SRC python :return table :var intable=filter-set-fakes
  from wfc3_utils import find_line_ratio, line_transmission_adjustments
  import wfc3_utils
...
|--------+--------+--------+---------+---------------|
| FQ575N | F658N  | F547M  |   0.026 |         0.038 |
| FQ672N | FQ674N | F673N  |   0.531 |         0.574 |
| FQ672N | FQ674N | F547M  |   0.525 |         0.574 |
| FQ437N | F502N  | FQ436N |  -0.013 |         0.030 |
| FQ437N | F502N  | F547M  |   0.013 |         0.030 |
| F487N  | F656N  | F547M  |   0.305 |         0.328 |
