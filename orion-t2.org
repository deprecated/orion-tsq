...
**** TODO [0/3] Getting the normalizations right
...
+ [ ] I should check out the photometry kwds in the FITS header
+ [ ] I should compare with some 3rd party measurements
...
**** TODO [1/4] Little tweaks to improve things
...
#+BEGIN_SRC python :noweb yes :results file 
  ...
  ax_spec.scatter(xx[mm], yy[mm], c=odh_flux, vmin=0.0, vmax=fmax, s=50, alpha=0.6, marker='s')
  ax_spec.scatter(xxx[mmm], yyy[mmm], c=adal_flux, vmin=0.0, vmax=fmax, s=50, alpha=0.6, marker='>')
  ...
  scat1 = ax_wfc3.scatter(xx[mm], yy[mm], c=odh_flux, vmin=0.0, vmax=fmax, s=50, alpha=0.6, marker='s')
  ax_wfc3.scatter(xxx[mmm], yyy[mmm], c=adal_flux, vmin=0.0, vmax=fmax, s=50, alpha=0.6, marker='>')
