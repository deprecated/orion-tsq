...
python ~/Work/HST-STIS/spotless/spotless.py --data-range 0 3e-15 --multi-hdu --allow-shadows --output-id cr --verbose --debug bally-stis-hst10-g430l
#+END_SRC
...
: Edge detection with Canny method complete
: Filling of holes complete
: Number of bad pixels: 91063 (6.313% of total)
: Number of distinct bad pixel objects found: 241
