...
** TODO Use of the Rubin STIS slits to estimate color term
+ These overlap with our region
+ [ ] Work out which slits I need
+ [ ] Combine pairs to remove cosmic rays
+ [ ] Take slice through the WFC3 images to compare with the different filters
