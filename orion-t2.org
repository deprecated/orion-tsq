...
** Revisiting ORL diagnostics with Adal
   ...
   :END:
*** TODO [3/6] Plan of action for ORLs
+ [ ] Fit Gaussians to Adal's lines
+ [X] Redo the fitting to Manu's lines, but now including the entire map
...
#+END_EXAMPLE
  ...
  + [ ] Check what extra lines we might want to add to the fitting
    + Next to He I 4388: 4391.94 Ne II, 4409.30 NeII
    + [ ] He I lines that were missing: 5016, 5048
