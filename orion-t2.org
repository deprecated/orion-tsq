...
1. The 575/547 color correction is found to be 0.938, which is consistent within the errors to the value of 0.93 found from the Rubin spectrum
2. The "true" variation (that is, corrected for noise, see below) in the color correction (for this slit) is about 0.5% RMS and occurs on scales of >= 100 pixels, or 5 arcsec
