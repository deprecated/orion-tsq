...
cols = ["alpha_1", "beta_1", "gamma_1", "alpha_2", "beta_2", "gamma_2"]

table = [["Filters"] + cols, None]

d = ratio_coefficients()
table.append(["575, 658, 547"] + ["{:0.3g}".format(d[k]) for k in cols])
d = ratio_coefficients(wav1=6716, wav2=6731, I="FQ672N", II="FQ674N", III="F673N")
table.append(["672, 674, 673"] + ["{:0.3g}".format(d[k]) for k in cols])
d = ratio_coefficients(wav1=6716, wav2=6731, I="FQ672N", II="FQ674N", III="F547M")
table.append(["672, 674, 547"] + ["{:0.3g}".format(d[k]) for k in cols])
d = ratio_coefficients(wav1=4363, wav2=4340, I="FQ437N", II="FQ436N", III="F547M")
table.append(["437, 436, 547"] + ["{:0.3g}".format(d[k]) for k in cols])


#+END_SRC

#+RESULTS:
| Filters       |  alpha_1 |   beta_1 | gamma_1 |  alpha_2 |   beta_2 | gamma_2 |
|---------------+----------+----------+---------+----------+----------+---------|
| 575, 658, 547 |    5e-09 | 3.08e-09 |  0.0243 |   0.0333 |   0.0205 |  0.0394 |
| 672, 674, 673 |    0.128 |    0.184 |   0.164 |    0.114 |    0.163 |   0.114 |
| 672, 674, 547 | 3.87e-09 | 5.56e-09 |  0.0274 | 2.04e-09 | 2.93e-09 |  0.0191 |
| 437, 436, 547 | 2.56e-06 | 1.82e-06 |  0.0343 | 1.89e-07 | 1.34e-07 |  0.0482 |

So for the [N II] ratio, the continuum contribution coefficients \gamma for 575 and 658 are comparable - 2 to 4%, but the result will be more important for 575 since R_{II} > R_{III} > R_{I} by factors of 100:10:1
