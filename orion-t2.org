...
This now produces images with the ODH slits and the Manu fibers
...
#+BEGIN_SRC python :noweb yes :results file 
  ...
  # inset plot with the S30 profile
  ax_inset = plt.axes([0.2, 0.1, 0.2, 0.2], axisbg='yellow')
  mm = mm & (yy == -30.0)
  ax_inset.plot(xx[mm],  odhtab[fn + '_s'][mm], '.')
  ax_inset.plot(xx[mm],  odhtab[fn + '_w'][mm], '.')
